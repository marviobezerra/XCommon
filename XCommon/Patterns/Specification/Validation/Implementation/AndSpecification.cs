...
{
	internal class AndSpecification<TEntity> : ISpecificationValidation<TEntity>
	{
		private ISpecificationValidation<TEntity> Spec1 { get; set; }
		private ISpecificationValidation<TEntity> Spec2 { get; set; }

		internal AndSpecification(ISpecificationValidation<TEntity> spec1, ISpecificationValidation<TEntity> spec2)
		{
			Spec1 = spec1;
			Spec2 = spec2;
		}
