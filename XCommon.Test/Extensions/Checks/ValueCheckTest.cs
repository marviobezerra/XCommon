...
namespace XCommon.Test.Extensions.Checks
{
    public class ValueCheckTest
    {
        ...
        public void BiggerThanDateTime(Pair<DateTime, DateTime> data, bool valid, string message)
        {
        ...
        public void BiggerThanDateTimeNoTime(Pair<DateTime, DateTime> data, bool valid, string message)
        {
        ...
        public void BiggerThanInt(Pair<int, int> data, bool valid, string message)
        {
            bool result = data.Item1.BiggerThan(data.Item2);
        ...
        public void BiggerThanDecimal(Pair<decimal, decimal> data, bool valid, string message)
        {
            bool result = data.Item1.BiggerThan(data.Item2);
        ...
        public void LessThanDateTime(Pair<DateTime, DateTime> data, bool valid, string message)
        {
        ...
        public void LessThanDateTimeNoTime(Pair<DateTime, DateTime> data, bool valid, string message)
        {
        ...
        public void LessThanInt(Pair<int, int> data, bool valid, string message)
        {
            bool result = data.Item1.LessThan(data.Item2);
        ...
        public void LessThanDecimal(Pair<decimal, decimal> data, bool valid, string message)
        {
            bool result = data.Item1.LessThan(data.Item2);
        ...
        public void InRangeDateTime(Pair<DateTime, DateTime, DateTime> data, bool valid, string message)
        {
        ...
        public void InRangeDateTimeNoTime(Pair<DateTime, DateTime, DateTime> data, bool valid, string message)
        {
        ...
        public void InRangeInt(Pair<int, int, int> data, bool valid, string message)
        {
            bool result = data.Item1.InRange(data.Item2, data.Item3);
        ...
        public void InRangeDecimal(Pair<decimal, decimal, decimal> data, bool valid, string message)
        {
            bool result = data.Item1.InRange(data.Item2, data.Item3);
