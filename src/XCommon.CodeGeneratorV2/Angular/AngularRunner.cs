		...
		private string ParsePath(ItemType type, string module, string feature)
		{
			...
			switch (type)
			{
				...
				case ItemType.Directive:
					return Path.Combine(Config.Angular.AppPath, module, "directives");
				case ItemType.Service:
					return Path.Combine(Config.Angular.AppPath, module, "services");
				case ItemType.Pipe:
					return Path.Combine(Config.Angular.AppPath, module, "pipes");
				case ItemType.Component:
				default:
					return Path.Combine(Config.Angular.AppPath, module, "components", feature);
			}
		}
