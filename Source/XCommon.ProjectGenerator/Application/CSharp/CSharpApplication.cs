...
using XCommon.ProjectGenerator.Application.CSharp.Extension;
using XCommon.Application.CommandLine;
using XCommon.ProjectGenerator.Application.CSharp.Writter;
using XCommon.ProjectGenerator.Application.CSharp.Enumeration;
using XCommon.ProjectGenerator.Application.Commands;
using XCommon.ProjectGenerator.Application.Angular;

namespace XCommon.ProjectGenerator.Application.CSharp
{
