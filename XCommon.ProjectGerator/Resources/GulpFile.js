...
gulp.task(helper.tasks.dnx.ts, shell.task(['dotnet run --project ../[{codegenerator}]/project.json -- -t']));
gulp.task(helper.tasks.dnx.sass, shell.task(['dotnet run --project ../[{codegenerator}]/project.json -- -a -u']));